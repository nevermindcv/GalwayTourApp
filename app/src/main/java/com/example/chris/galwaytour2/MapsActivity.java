...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        normalbutton = (Button)findViewById(R.id.placenormalbtn);
    ...
    public void Galwaymarkers (GoogleMap googleMap){
        mMap = googleMap;
        ...
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(GalwayCathedral,14),5000,null);
